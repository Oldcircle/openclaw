...
For a practical breakdown of injected files, Context Books, Prompt Profiles, tools, skills, and overall system prompt size, use `/context list` or `/context detail`. See [Context](/concepts/context).
