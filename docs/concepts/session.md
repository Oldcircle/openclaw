...
- Send `/context list` or `/context detail` to see what’s in the system prompt, injected workspace files, and asset-driven prompt sections such as Context Books and Prompt Profiles (and the biggest context contributors).
